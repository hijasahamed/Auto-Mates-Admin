          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  TextWidget(text: 'All Cars', color: colorWhite, size: screenSize.width/100, weight: FontWeight.bold),
                ...
                child: Center(
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return TextWidget(text: 'Total No.of Cars : ${count.toString()}', color: colorWhite, size: screenSize.width/100, weight: FontWeight.bold);
                    },
                  ),
                )
              )
